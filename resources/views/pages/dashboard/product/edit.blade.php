                        ...
                        <div class="w-full px-3">
                            ...
                            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                    ...
                                    <textarea id="description" name="description" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an description..." required>{{ old('description') ?? $item->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
